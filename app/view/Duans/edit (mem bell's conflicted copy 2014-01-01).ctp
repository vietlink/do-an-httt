 	...
 	<form class="form-horizontal" method='post' role="form">
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      ...
	      <input type="number" name="data[Duan][id]" value="<?php echo $this->data['Duan']['id']; ?>" hidden="">
	    </div>
	  </div>
	   <div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	       ...
	       <input type="number" name="data[Duan][subLeadercu]" value="<?php echo $this->data['Duan']['id_subLeader']; ?>" hidden="">
	    </div>
	  </div>
