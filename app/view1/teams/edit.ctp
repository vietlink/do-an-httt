<div class="Teams form">
	<?php echo $this->form->create('Team',array('action'=>'edit')); ?>
	<?php echo $this->form->input('name',array('label'=>'Tên','placeholder' => 'Tên Team'));?>
	...
	<?php echo $this->form->input('id',array('label'=>false));?>
		...
		<?php echo $this->form->select('quanly_id',$listnhanviens,array('required'=>"required"));?>
		<div class="related">
