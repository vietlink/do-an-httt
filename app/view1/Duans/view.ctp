	...
	<div class="col-md-6">
		...
		<table class="table table-bordered">
			...
			<tr>
			    ...
			    <td><?php echo $this->Html->link(__($quanly['tenNhanVien']), array('controller' => 'Nhanviens', 'action' => 'view', $quanly['id'])); ?></td>
			</tr>														
		</table>
	</div>
		   ...
		   <?php if (!empty($nhanvien)): ?>
		    <tbody>
		    	<?php
					...
					<?php if(($taikhoan['DuansNhanvien']['public']==1)&&($taikhoan['DuansNhanvien']['vitri']=='Developer')): ?>
					<tr>
						<td><?php echo $i++; ?></td>
