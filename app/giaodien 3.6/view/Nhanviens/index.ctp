...
<!--             <th>id</th> -->
	...
	<tr>
		...
		<td><?php echo $this->Html->link(
					    	$this->Html->tag('span', $nhanvien['Nhanvien']['tenNhanVien'], array('data-title' => $nhanvien['Nhanvien']['tenNhanVien'])),
							array('action' => 'view', $nhanvien['Nhanvien']['id']),
							array('escape'=>false,'class'=>'external roll-link')); ?>
		</td>
