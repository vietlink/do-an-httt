<div class="taikhoans index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('id_nhanvien'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($taikhoan['Taikhoan']['nhanvien_id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $taikhoan['Taikhoan']['id'])); ?>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Nhanvien'), array('controller' => 'Nhanviens','action' => 'index')); ?></li>
